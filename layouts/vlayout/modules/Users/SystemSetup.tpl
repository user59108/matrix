            ...
            <div class="container-fluid page-container">
                ...
                <div class="row-fluid main-container">
                    <div class="span12 inner-container">
                        <div class="row-fluid">
                            <div class="span8">
                                <h3 style="display: inline-block;float:left;"> Что бы вы хотели использовать в Vtiger CRM?</h3> 
								<p style="display: inline-block;float:left;margin-top:4px;">&nbsp;&nbsp;(Выберите функции, которые хотите включить)</p>
                            </div>
							<div class="span4">
						...
						<form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave">
							...
							{foreach from=$PACKAGES_LIST key=PACKAGE_NAME item=PACKAGE_INFO}
								{if $COUNTER eq 0 || $COUNTER mod 2 eq 1}
									...
									<div class="group-container {if $COUNTER eq 0} span12 selectedContainer js-basePack {else} span6 {/if}">
										<div class="module_list"><a> Посмотреть модули </a></div>
										<div class="row-fluid">
										...
										{if $COUNTER eq 0}		
											<div class="row-fluid">
												<div class="offset2 span10">
													...
													<strong> Эта функция будет установлена по умолчанию </strong></label>
												</div>
											</div>
										{/if}
										<div class="reveal_modules">
											<div>
												...
												<strong>Эти модули будут включены для этой функции</strong><hr>
												<div>	
							...
							<div class="row-fluid">
								<div class="span9">
									<strong>Примечание: </strong> Вы можете включить/отключить модули из менеджера модулей позже   
								</div>
								<div class="span3">

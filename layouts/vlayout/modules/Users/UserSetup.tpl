						...
						<div class="row">
							...
							<div class="span4">
								{*<label class="control-label"><strong>Preferences</strong> <span class="muted">{vtranslate('LBL_ALL_FIELDS_BELOW_ARE_REQUIRED', $MODULE)}</label>*}
                                                                {* Frodis.ru - Начало *}
                                                                <label class="control-label"><strong>{vtranslate('LBL_MY_PREFERENCES', $MODULE)}</strong> <span class="muted">{vtranslate('LBL_ALL_FIELDS_BELOW_ARE_REQUIRED', $MODULE)}</label>
                                                                {* Frodis.ru - Конец *}

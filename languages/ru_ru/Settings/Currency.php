...
$languageStrings = array(
    ...
    'LBL_EDIT_CURRENCY' => 'Изменить валюту', 
    ...
    'LBL_ENTER_CONVERSION_RATE' => 'Введите коэффициент обращения', 
    'LBL_CURRENCY_STATUS_DESC' => 'Включите опцию, чтобы сделать валюту активной', 
...
$jsLanguageStrings = array(
    'JS_CURRENCY_DETAILS_SAVED' => 'Параметры валюты сохранены', 
    'JS_CURRENCY_DELETED_SUEESSFULLY' => 'Валюты удалены успешно', 
);

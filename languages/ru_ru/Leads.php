...
$languageStrings = array(
    ...
    'LBL_CONVERT_LEAD_ERROR_TITLE' => 'Неработоспособные модули', 
    ...
    'LBL_CUSTOM_FIELD_MAPPING' => 'Редактировать сопостовление полей', 
    'LBL_WEBFORMS' => 'Настройка Веб-форм', 
    'LBL_LEAD_SOURCE' => 'Источник:', 

//Frodis - Начало
    'Hot Leads' => 'Срочные обращения', 
    'This Month Leads' => 'Обращения в этом месяце', 
    'LBL_CREATING_NEW' => 'Создать новое', 
    'Module_PP' => 'обращении', 
    'LBL_TRANSFER_RELATED_RECORD' => 'Перенести запись к',
//Frodis - Конец
);

...
if(c!==g&&(d="container"===a[0]?c.container:c[a[0]].apply(c,a.slice(1)),d!==g))return!1}else throw"Invalid arguments to select2 plugin: "+a;});return d===g?this:d};e.fn.select2.defaults={width:"copy",closeOnSelect:!0,openOnEnter:!0,containerCss:{},dropdownCss:{},containerCssClass:"",dropdownCssClass:"",formatResult:function(a,b,c){b=[];B(a.text,c.term,b);return b.join("")},formatSelection:function(a){return a?a.text:g},formatResultCssClass:function(){return g},formatNoMatches:function(){/*return"No matches found"*/ /* Frodis.ru - Начало */ return "Ничего не найдено" /* Frodis.ru - Конец */},
formatInputTooShort:function(a,b){/*return"Please enter "+(b-a.length)+" more characters"*/ /* Frodis.ru - Начало */ if((b-a.length)==1){return"Пожалуйста, введите еще "+(b-a.length)+" символ"}else return"Пожалуйста, введите еще "+(b-a.length)+" символа" /* Frodis.ru - Конец */},formatSelectionTooBig:function(a){return"You can only select "+a+" item"+(1==a?"":"s")},formatLoadMore:function(){return"Loading more results..."},formatSearching:function(){/*return"Searching..."*/ /* Frodis.ru - Начало*/ return"Поиск..." /* Frodis.ru - Конец*/},minimumResultsForSearch:0,minimumInputLength:0,maximumSelectionSize:0,id:function(a){return a.id},matcher:function(a,b){return 0<=b.toUpperCase().indexOf(a.toUpperCase())},separator:",",tokenSeparators:[],tokenizer:H,

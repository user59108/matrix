...
class Vtiger_DetailView_Model extends Vtiger_Base_Model {
	...
	public function getDetailViewRelatedLinks() {
		...
		$relatedLinks = array();
                ...
                // Frodis.ru - Начало
		include_once 'include/Frodis/determineFirstLetter.php';
                $details = determineFirstLetter($moduleName, 'LBL_DETAILS');
                $record_summary = determineFirstLetter($moduleName, 'LBL_SUMMARY');
                // Frodis.ru - Конец 

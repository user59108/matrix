...
class Install_Utils_Model {
	...
	static function getCurrentDirectiveValue() {
		...
		if (ini_get('error_reporting') != $errorReportingValue)
                        ...
                        // Frodis.ru - Начало
			$directiveValues['error_reporting'] = getTranslatedString('NOT RECOMMENDED', 'Install');
                        // Frodis.ru - Конец
	...
	function getSystemPreInstallParameters() {
		...
		$preInstallConfig['LBL_PHP_VERSION']	= array(phpversion(), '5.5 - 5.6', (version_compare(phpversion(), '5.7.0', '<=')));
